...
import run.halo.app.core.extension.Comparators;
...
import run.halo.app.core.extension.router.IListRequest;
...
import static run.halo.app.core.extension.ListResult.generateGenericClass;
import static run.halo.app.core.extension.router.QueryParamBuildUtil.buildParametersFromType;
...
public class AttachmentEndpoint implements CustomEndpoint {
    ...
    public static class SearchRequest extends QueryListRequest implements ISearchRequest {
        ...
        public Predicate<Attachment> toPredicate() {
            ...
            var selectorPred =
                SelectorUtil.labelAndFieldSelectorToPredicate(getLabelSelector(), getFieldSelector());
